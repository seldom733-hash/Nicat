...
export const countries: Country[] = [
  ...
  { code: 'HR', name: 'Croatia', nameRu: 'Хорватия', nameAz: 'Xorvatiya', cities: ['Zagreb', 'Dubrovnik', 'Split', 'Zadar', 'Pula', 'Hvar', 'Rovinj', 'Opatija', 'Trogir', 'Šibenik', 'Korčula', 'Makarska', 'Plitvice Lakes', 'Vis'] },
  ...
  { code: 'FR', name: 'France', nameRu: 'Франция', nameAz: 'Fransa', cities: ['Paris', 'Nice', 'Lyon', 'Marseille', 'Bordeaux', 'Strasbourg', 'Mont Saint-Michel', 'Cannes', 'Chamonix', 'Toulouse', 'Nantes', 'Dijon', 'Saint-Tropez', 'Avignon', 'Aix-en-Provence', 'Reims', 'Lille', 'Annecy', 'Colmar', 'Biarritz'] },
  { code: 'DE', name: 'Germany', nameRu: 'Германия', nameAz: 'Almaniya', cities: ['Berlin', 'Munich', 'Hamburg', 'Frankfurt', 'Cologne', 'Dresden', 'Nuremberg', 'Heidelberg', 'Stuttgart', 'Leipzig', 'Hannover', 'Düsseldorf', 'Freiburg', 'Bamberg', 'Rothenburg', 'Potsdam'] },
  { code: 'GR', name: 'Greece', nameRu: 'Греция', nameAz: 'Yunanıstan', cities: ['Athens', 'Santorini', 'Mykonos', 'Thessaloniki', 'Rhodes', 'Crete', 'Corfu', 'Zakynthos', 'Paros', 'Naxos', 'Milos', 'Halkidiki', 'Delphi', 'Meteora', 'Oia', 'Chania', 'Heraklion', 'Lefkada', 'Skiathos', 'Kos'] },
  ...
  { code: 'IT', name: 'Italy', nameRu: 'Италия', nameAz: 'İtaliya', cities: ['Rome', 'Milan', 'Venice', 'Florence', 'Naples', 'Amalfi', 'Cinque Terre', 'Pisa', 'Bologna', 'Siena', 'Verona', 'Genoa', 'Turin', 'Catania', 'Positano', 'Ravello', 'Capri', 'Portofino', 'Matera', 'Lucca'] },
  ...
  { code: 'PL', name: 'Poland', nameRu: 'Польша', nameAz: 'Polşa', cities: ['Warsaw', 'Kraków', 'Gdańsk', 'Wrocław', 'Poznań', 'Zakopane', 'Toruń', 'Łódź', 'Lublin', 'Katowice', 'Wieliczka', 'Sopot', 'Malbork', 'Białowieża'] },
  { code: 'PT', name: 'Portugal', nameRu: 'Португалия', nameAz: 'Portuqaliya', cities: ['Lisbon', 'Porto', 'Faro', 'Sintra', 'Madeira', 'Azores', 'Óbidos', 'Coimbra', 'Évora', 'Braga', 'Funchal', 'Tavira', 'Lagos', 'Cascais', 'Setúbal'] },
  ...
  { code: 'ES', name: 'Spain', nameRu: 'Испания', nameAz: 'İspaniya', cities: ['Madrid', 'Barcelona', 'Seville', 'Valencia', 'Granada', 'Ibiza', 'Mallorca', 'San Sebastián', 'Toledo', 'Bilbao', 'Córdoba', 'Malaga', 'Alicante', 'Zaragoza', 'Santiago de Compostela', 'Ronda', 'Segovia', 'Salamanca', 'Pamplona', 'Menorca'] },
  ...
  { code: 'TR', name: 'Turkey', nameRu: 'Турция', nameAz: 'Türkiyə', cities: ['Istanbul', 'Ankara', 'Antalya', 'Cappadocia', 'Bodrum', 'Izmir', 'Pamukkale', 'Ephesus', 'Kalkan', 'Marmaris', 'Fethiye', 'Kusadasi', 'Alanya', 'Kas', 'Side', 'Belek', 'Dalaman', 'Sapanca', 'Trabzon', 'Capadocia Uchisar'] },
  { code: 'UA', name: 'Ukraine', nameRu: 'Украина', nameAz: 'Ukrayna', cities: ['Kyiv', 'Lviv', 'Odesa', 'Kharkiv', 'Vinnytsia', 'Chernivtsi'] },
  { code: 'GB', name: 'United Kingdom', nameRu: 'Великобритания', nameAz: 'Böyük Britaniya', cities: ['London', 'Edinburgh', 'Bath', 'Oxford', 'Cambridge', 'Liverpool', 'Manchester', 'York', 'Brighton', 'Stonehenge', 'Cotswolds', 'Lake District', 'Windsor', 'Stratford-upon-Avon', 'Canterbury', 'Inverness', 'Glasgow', 'Cardiff', 'Belfast', 'Dover'] },
  ...
  { code: 'AZ', name: 'Azerbaijan', nameRu: 'Азербайджан', nameAz: 'Azərbaycan', cities: ['Baku', 'Ganja', 'Sheki', 'Shamakhi', 'Gabala', 'Lankaran', 'Nakhchivan', 'Quba', 'Qusar', 'Shahdag', 'Zaqatala', 'Goygol', 'Mingachevir', 'Sumqayit', 'Khachmaz', 'Zangilan', 'Kalbajar', 'Lachin', 'Fuzuli', 'Shusha', 'Naftalan', 'Ismayilli', 'Gobustan', 'Absheron', 'Xankendi', 'Agdam', 'Barda', 'Yevlakh', 'Aghjabadi', 'Masalli', 'Astara', 'Balakan', 'Dashkasan', 'Shabran'] },
  ...
  { code: 'IN', name: 'India', nameRu: 'Индия', nameAz: 'Hindistan', cities: ['New Delhi', 'Mumbai', 'Jaipur', 'Agra', 'Varanasi', 'Goa', 'Kerala', 'Udaipur', 'Shimla', 'Darjeeling', 'Rishikesh', 'Hampi', 'Pondicherry', 'Jodhpur', 'Manali'] },
  { code: 'ID', name: 'Indonesia', nameRu: 'Индонезия', nameAz: 'İndoneziya', cities: ['Jakarta', 'Bali', 'Yogyakarta', 'Lombok', 'Raja Ampat', 'Komodo', 'Bandung', 'Ubud', 'Seminyak', 'Gili Islands', 'Flores', 'Malang', 'Solo', 'Medan', 'Lake Toba'] },
  ...
  { code: 'JP', name: 'Japan', nameRu: 'Япония', nameAz: 'Yaponiya', cities: ['Tokyo', 'Kyoto', 'Osaka', 'Hiroshima', 'Nara', 'Nagoya', 'Fukuoka', 'Sapporo', 'Mount Fuji', 'Okinawa', 'Kobe', 'Yokohama', 'Kanazawa', 'Takayama', 'Nikko', 'Hakone', 'Naoshima', 'Tsumago', 'Kamakura', 'Sendai'] },
  ...
  { code: 'KR', name: 'South Korea', nameRu: 'Южная Корея', nameAz: 'Cənubi Koreya', cities: ['Seoul', 'Busan', 'Jeju', 'Incheon', 'Gyeongju', 'Gangneung', 'Daegu', 'Daejeon', 'Jeonju', 'Andong', 'Sokcho', 'Chuncheon'] },
  ...
  { code: 'TH', name: 'Thailand', nameRu: 'Таиланд', nameAz: 'Tayland', cities: ['Bangkok', 'Chiang Mai', 'Phuket', 'Krabi', 'Pattaya', 'Koh Samui', 'Ayutthaya', 'Pai', 'Phi Phi Islands', 'Chiang Rai', 'Koh Tao', 'Koh Phangan', 'Khao Lak', 'Hua Hin', 'Nonthaburi', 'Sukhothai'] },
  { code: 'TL', name: 'Timor-Leste', nameRu: 'Восточный Тимор', nameAz: 'Şərqi Timor', cities: ['Dili', 'Baucau', 'Lospalos'] },
  { code: 'AE', name: 'United Arab Emirates', nameRu: 'ОАЭ', nameAz: 'BƏA', cities: ['Dubai', 'Abu Dhabi', 'Sharjah', 'Ajman', 'Ras Al Khaimah', 'Fujairah', 'Umm Al Quwain', 'Al Ain', 'Jebel Ali', 'Palm Jumeirah'] },
  { code: 'UZ', name: 'Uzbekistan', nameRu: 'Узбекистан', nameAz: 'Özbəkistan', cities: ['Tashkent', 'Samarkand', 'Bukhara', 'Khiva', 'Nukus', 'Fergana'] },
  { code: 'VN', name: 'Vietnam', nameRu: 'Вьетнам', nameAz: 'Vyetnam', cities: ['Hanoi', 'Ho Chi Minh City', 'Da Nang', 'Hoi An', 'Ha Long Bay', 'Nha Trang', 'Sapa', 'Phú Quốc', 'Hue', 'Ninh Binh', 'Phong Nha', 'Dalat', 'Mui Ne', 'Can Tho', 'Mai Chau'] },
  ...
  { code: 'EG', name: 'Egypt', nameRu: 'Египет', nameAz: 'Misir', cities: ['Cairo', 'Alexandria', 'Luxor', 'Aswan', 'Hurghada', 'Sharm El Sheikh', 'Giza', 'Dahab', 'Fayoum', 'Siwa Oasis', 'Marsa Alam', 'El Gouna', 'Taba', 'Safaga'] },
  ...
  { code: 'MA', name: 'Morocco', nameRu: 'Марокко', nameAz: 'Mərakeş', cities: ['Marrakech', 'Casablanca', 'Fez', 'Chefchaouen', 'Tangier', 'Essaouira', 'Rabat', 'Agadir', 'Meknes', 'Ouarzazate', 'Merzouga', 'Ifrane', 'Asilah'] },
  ...
  { code: 'ZA', name: 'South Africa', nameRu: 'ЮАР', nameAz: 'Cənub Afrika Respublikası', cities: ['Cape Town', 'Johannesburg', 'Durban', 'Pretoria', 'Kruger National Park', 'Garden Route', 'Stellenbosch', 'Franschhoek', 'Knysna', 'Hermanus', 'Port Elizabeth', 'Sun City'] },
  ...
  { code: 'MX', name: 'Mexico', nameRu: 'Мексика', nameAz: 'Meksika', cities: ['Mexico City', 'Cancún', 'Tulum', 'Playa del Carmen', 'Oaxaca', 'Guadalajara', 'Monterrey', 'San Miguel de Allende', 'Puerto Vallarta', 'Cabo San Lucas', 'Mérida', 'Puerto Escondido', 'Sayulita', 'Isla Mujeres', 'Teotihuacán'] },
  ...
  { code: 'US', name: 'United States', nameRu: 'США', nameAz: 'ABŞ', cities: ['New York', 'Los Angeles', 'San Francisco', 'Las Vegas', 'Miami', 'Chicago', 'Honolulu', 'Orlando', 'Boston', 'Seattle', 'Washington D.C.', 'Austin', 'Nashville', 'Denver', 'San Diego', 'New Orleans', 'Savannah', 'Philadelphia', 'Portland', 'Scottsdale'] },
  ...
  { code: 'BR', name: 'Brazil', nameRu: 'Бразилия', nameAz: 'Braziliya', cities: ['Rio de Janeiro', 'São Paulo', 'Salvador', 'Fortaleza', 'Brasília', 'Manaus', 'Recife', 'Búzios', 'Florianópolis', 'Foz do Iguaçu', 'Porto Alegre', 'Natal', 'Olinda', 'Paraty', 'Chapada Diamantina'] },
  ...
  { code: 'CO', name: 'Colombia', nameRu: 'Колумбия', nameAz: 'Kolumbiya', cities: ['Bogotá', 'Cartagena', 'Medellín', 'Cali', 'Santa Marta', 'Salento', 'San Agustín', 'Tayrona', 'Guatapé', 'Villa de Leyva', 'Popayán'] },
  ...
  { code: 'PE', name: 'Peru', nameRu: 'Перу', nameAz: 'Peru', cities: ['Lima', 'Cusco', 'Machu Picchu', 'Arequipa', 'Sacred Valley', 'Nazca', 'Iquitos', 'Lake Titicaca', 'Huaraz', 'Colca Canyon', 'Puno', 'Trujillo', 'Paracas'] },
  ...
  // Oceania
  { code: 'AU', name: 'Australia', nameRu: 'Австралия', nameAz: 'Avstraliya', cities: ['Sydney', 'Melbourne', 'Brisbane', 'Perth', 'Gold Coast', 'Cairns', 'Great Barrier Reef', 'Uluru', 'Adelaide', 'Hobart', 'Canberra', 'Byron Bay', 'Phillip Island', 'Blue Mountains', 'Rottnest Island'] },
  ...
  { code: 'NZ', name: 'New Zealand', nameRu: 'Новая Зеландия', nameAz: 'Yeni Zelandiya', cities: ['Auckland', 'Queenstown', 'Christchurch', 'Wellington', 'Rotorua', 'Milford Sound', 'Hobbiton', 'Wanaka', 'Taupo', 'Napier', 'Abel Tasman', 'Kaikoura', 'Fox Glacier', 'Dunedin'] },
...
export const serviceCategories: ServiceCategory[] = [
  ...
  // Еда и гастрономия
  {
    ...
    services: [
      ...
      { id: 'cooking-classes', name: 'Cooking Classes', nameRu: 'Кулинарные мастер-классы', nameAz: 'Kulinariya dərsləri' },
      { id: 'street-food-tours', name: 'Street Food Tours', nameRu: 'Туры по уличной еде', nameAz: 'Küçə yeməyi turları' },
      { id: 'brewery-tours', name: 'Brewery Tours', nameRu: 'Пивоваренные туры', nameAz: 'Pivə zavodu turları' },
    ],
  },
  ...
  // Развлечения и вечеринки
  {
    ...
    nameAz: 'Əyləncə və partiyalar',
    services: [
      { id: 'party-trips', name: 'Party Trips', nameRu: 'Вечеринки', nameAz: 'Partiya səfərləri' },
      { id: 'festival-tours', name: 'Festival Tours', nameRu: 'Фестивальные туры', nameAz: 'Festivallar turu' },
      { id: 'music-festivals', name: 'Music Festivals', nameRu: 'Музыкальные фестивали', nameAz: 'Musiqi festivalları' },
      { id: 'beach-parties', name: 'Beach Parties', nameRu: 'Пляжные вечеринки', nameAz: 'Çimərlik partiyaları' },
      { id: 'clubbing-tours', name: 'Clubbing Tours', nameRu: 'Ночные клубы', nameAz: 'Klub gecələri turları' },
      { id: 'concert-tours', name: 'Concert Tours', nameRu: 'Концертные туры', nameAz: 'Konsert turları' },
    ],
  },
  ...
  // Природа
  {
    ...
    nameAz: 'Təbiət',
    services: [
      { id: 'nature-tours', name: 'Nature Tours', nameRu: 'Туры по природе', nameAz: 'Təbiət turları' },
      { id: 'national-parks', name: 'National Parks', nameRu: 'Национальные парки', nameAz: 'Milli parklar' },
      { id: 'wildlife-tours', name: 'Wildlife Tours', nameRu: 'Наблюдение за животными', nameAz: 'Vəhşi təbiət turları' },
      { id: 'bird-watching', name: 'Bird Watching', nameRu: 'Наблюдение за птицами', nameAz: 'Quş müşahidəsi' },
      { id: 'eco-tourism', name: 'Eco Tourism', nameRu: 'Эко-туризм', nameAz: 'Ekoturizm' },
      { id: 'sustainable-travel', name: 'Sustainable Travel', nameRu: 'Устойчивый туризм', nameAz: 'Davamlı səyahət' },
    ],
  },
  ...
  // Тематические путешествия
  {
    ...
    nameAz: 'Tematik səyahətlər',
    services: [
      { id: 'anime-tours', name: 'Anime Tours', nameRu: 'Аниме-туры', nameAz: 'Anime turları' },
      { id: 'manga-tours', name: 'Manga Tours', nameRu: 'Манга-туры', nameAz: 'Manga turları' },
      { id: 'gaming-tours', name: 'Gaming Tours', nameRu: 'Игровые туры', nameAz: 'Oyun turları' },
      { id: 'movie-location-tours', name: 'Movie Location Tours', nameRu: 'Туры по местам съёмок', nameAz: 'Film çəkiliş yerləri turları' },
      { id: 'k-pop-tours', name: 'K-Pop Tours', nameRu: 'K-Pop туры', nameAz: 'K-Pop turları' },
      { id: 'formula-1-tours', name: 'Formula 1 Tours', nameRu: 'Туры Формулы 1', nameAz: 'Formula 1 turları' },
      { id: 'football-tours', name: 'Football Tours', nameRu: 'Футбольные туры', nameAz: 'Futbol turları' },
      { id: 'sports-events', name: 'Sports Events', nameRu: 'Спортивные события', nameAz: 'İdman tədbirləri' },
      { id: 'fashion-tours', name: 'Fashion Tours', nameRu: 'Модные туры', nameAz: 'Moda turları' },
      { id: 'art-tours', name: 'Art Tours', nameRu: 'Туры по искусству', nameAz: 'İncəsənət turları' },
    ],
  },
  ...
  // Для женщин
  {
    ...
    name: 'For Women',
    nameRu: 'Для женщин',
    nameAz: 'Qadınlar üçün',
    services: [
      { id: 'girls-only', name: 'Girls Only', nameRu: 'Только для девушек', nameAz: 'Yalnız qızlar' },
      { id: 'women-retreats', name: 'Women Retreats', nameRu: 'Женские ретриты', nameAz: 'Qadınlar retritləri' },
      { id: 'women-adventures', name: 'Women Adventures', nameRu: 'Женские приключения', nameAz: 'Qadınlar macəraları' },
      { id: 'women-wellness', name: 'Women Wellness', nameRu: 'Женский wellness', nameAz: 'Qadınlar wellness' },
    ],
  },
  ...
  // Для мужчин
  {
    ...
    nameAz: 'Kişilər üçün',
    services: [
      { id: 'men-only-trips', name: 'Men Only Trips', nameRu: 'Только для мужчин', nameAz: 'Yalnız kişilər səfərləri' },
      { id: 'mens-adventure-retreats', name: "Men's Adventure Retreats", nameRu: 'Мужские приключенческие ретриты', nameAz: 'Kişilər macəra retritləri' },
    ],
  },
  ...
  // Для пар
  {
    ...
    nameAz: 'Cütlər üçün',
    services: [
      { id: 'couples-trips', name: 'Couples Trips', nameRu: 'Путешествия для пар', nameAz: 'Cütlər səfərləri' },
      { id: 'honeymoon-tours', name: 'Honeymoon Tours', nameRu: 'Медовые месяцы', nameAz: 'Bal ayı turları' },
      { id: 'romantic-getaways', name: 'Romantic Getaways', nameRu: 'Романтические поездки', nameAz: 'Romantik səfərlər' },
      { id: 'proposal-trips', name: 'Proposal Trips', nameRu: 'Поездки для предложений', nameAz: 'Təklif səfərləri' },
    ],
  },
  ...
  // Для семей
  {
    ...
    nameAz: 'Ailələr üçün',
    services: [
      { id: 'family-trips', name: 'Family Trips', nameRu: 'Семейные путешествия', nameAz: 'Ailə səfərləri' },
      { id: 'family-adventure', name: 'Family Adventure', nameRu: 'Семейные приключения', nameAz: 'Ailə macərası' },
      { id: 'kids-friendly-tours', name: 'Kids Friendly Tours', nameRu: 'Детские туры', nameAz: 'Uşaqlar üçün turlar' },
      { id: 'multi-generation-travel', name: 'Multi-Generation Travel', nameRu: 'Путешествия для нескольких поколений', nameAz: 'Çox nəsilli səyahət' },
    ],
  },
  ...
  // Для одиночных путешественников
  {
    ...
    nameAz: 'Tək səyyahlar üçün',
    services: [
      { id: 'solo-travel', name: 'Solo Travel', nameRu: 'Одиночные путешествия', nameAz: 'Tək səyahət' },
      { id: 'solo-female-travel', name: 'Solo Female Travel', nameRu: 'Путешествия для девушек', nameAz: 'Qadınların tək səyahəti' },
      { id: 'social-travel', name: 'Social Travel', nameRu: 'Социальные путешествия', nameAz: 'Sosial səyahət' },
      { id: 'meet-new-people-trips', name: 'Meet New People Trips', nameRu: 'Знакомство с новыми людьми', nameAz: 'Yeni insanlarla tanışlıq səfərləri' },
    ],
  },
  ...
  // Возрастные категории
  {
    ...
    nameAz: 'Yaş qrupları',
    services: [
      { id: 'youth-travel-18-25', name: 'Youth Travel (18–25)', nameRu: 'Молодёжь (18–25)', nameAz: 'Gənclər səyahəti (18–25)' },
      { id: 'young-professionals', name: 'Young Professionals', nameRu: 'Молодые специалисты', nameAz: 'Gənc mütəxəssislər' },
      { id: '30-plus-travel', name: '30+ Travel', nameRu: '30+', nameAz: '30+ səyahət' },
      { id: '40-plus-travel', name: '40+ Travel', nameRu: '40+', nameAz: '40+ səyahət' },
      { id: '50-plus-travel', name: '50+ Travel', nameRu: '50+', nameAz: '50+ səyahət' },
      { id: 'senior-travel', name: 'Senior Travel', nameRu: 'Пожилые путешественники', nameAz: 'Yaşlı səyyahlar' },
    ],
  },
  ...
  // Бизнес и обучение
  {
    ...
    nameAz: 'Biznes və təhsil',
    services: [
      { id: 'business-travel', name: 'Business Travel', nameRu: 'Бизнес-путешествия', nameAz: 'Biznes səyahəti' },
      { id: 'networking-trips', name: 'Networking Trips', nameRu: 'Поездки для нетворкинга', nameAz: 'Şəbəkə qurma səfərləri' },
      { id: 'conferences', name: 'Conferences', nameRu: 'Конференции', nameAz: 'Konfranslar' },
      { id: 'mastermind-retreats', name: 'Mastermind Retreats', nameRu: 'Мастермайнд-ретриты', nameAz: 'Mastermind retritləri' },
      { id: 'educational-tours', name: 'Educational Tours', nameRu: 'Образовательные туры', nameAz: 'Təhsil turları' },
      { id: 'language-learning-trips', name: 'Language Learning Trips', nameRu: 'Поездки для изучения языка', nameAz: 'Dil öyrənmə səfərləri' },
      { id: 'university-tours', name: 'University Tours', nameRu: 'Туры по университетам', nameAz: 'Universitet turları' },
    ],
  },
  ...
  // По длительности
  {
    ...
    nameAz: 'Müddətə görə',
    services: [
      { id: 'day-trips', name: 'Day Trips', nameRu: 'Однодневные туры', nameAz: 'Günlük turlar' },
      { id: 'weekend-trips-duration', name: 'Weekend Trips', nameRu: 'Выходные', nameAz: 'Həftəsonu səfərləri' },
      { id: '3-5-days', name: '3–5 Days', nameRu: '3–5 дней', nameAz: '3–5 gün' },
      { id: '1-week', name: '1 Week', nameRu: '1 неделя', nameAz: '1 həftə' },
      { id: '2-weeks', name: '2 Weeks', nameRu: '2 недели', nameAz: '2 həftə' },
      { id: '1-month-plus', name: '1 Month+', nameRu: '1 месяц+', nameAz: '1 ay+' },
      { id: 'long-term-travel', name: 'Long-Term Travel', nameRu: 'Долгосрочные путешествия', nameAz: 'Uzunmüddətli səyahət' },
    ],
  },
  ...
  // По формату
  {
    ...
    nameAz: 'Formata görə',
    services: [
      { id: 'group-tours', name: 'Group Tours', nameRu: 'Групповые туры', nameAz: 'Qrup turları' },
      { id: 'small-group-tours', name: 'Small Group Tours', nameRu: 'Небольшие группы', nameAz: 'Kiçik qrup turları' },
      { id: 'private-tours', name: 'Private Tours', nameRu: 'Индивидуальные туры', nameAz: 'Fərdi turlar' },
      { id: 'customized-tours', name: 'Customized Tours', nameRu: 'Индивидуальные туры', nameAz: 'Fərdiləşdirilmiş turlar' },
      { id: 'self-guided-tours', name: 'Self-Guided Tours', nameRu: 'Самостоятельные туры', nameAz: 'Müstəqil turlar' },
      { id: 'hosted-tours', name: 'Hosted Tours', nameRu: 'Туры с гидом', nameAz: 'Bələdçili turlar' },
      { id: 'local-led-tours', name: 'Local-Led Tours', nameRu: 'Туры с местными жителями', nameAz: 'Yerli bələdçili turlar' },
    ],
  },
  ...
  // По размещению
  {
    ...
    nameAz: 'Yerləşdirməyə görə',
    services: [
      { id: 'hotel-stay', name: 'Hotel Stay', nameRu: 'Проживание в отеле', nameAz: 'Oteldə qalma' },
      { id: 'resort-stay', name: 'Resort Stay', nameRu: 'Проживание на курорте', nameAz: 'Kurortda qalma' },
      { id: 'villa-stay', name: 'Villa Stay', nameRu: 'Проживание в вилле', nameAz: 'Villada qalma' },
      { id: 'hostel-stay', name: 'Hostel Stay', nameRu: 'Проживание в хостеле', nameAz: 'Hosteldə qalma' },
      { id: 'eco-lodge', name: 'Eco Lodge', nameRu: 'Эко-лодж', nameAz: 'Ekoloji lodj' },
      { id: 'camping-accommodation', name: 'Camping', nameRu: 'Кемпинг', nameAz: 'Kempinq' },
      { id: 'glamping-accommodation', name: 'Glamping', nameRu: 'Глэмпинг', nameAz: 'Qlamping' },
      { id: 'homestay', name: 'Homestay', nameRu: 'Проживание у местных', nameAz: 'Ev qonağı' },
    ],
  },
  ...
  // По транспорту
  {
    ...
    nameAz: 'Nəqliyyata görə',
    services: [
      { id: 'road-trips', name: 'Road Trips', nameRu: 'Автопутешествия', nameAz: 'Avtomobil səfərləri' },
      { id: 'train-journeys', name: 'Train Journeys', nameRu: 'Железнодорожные путешествия', nameAz: 'Qatar səfərləri' },
      { id: 'luxury-trains', name: 'Luxury Trains', nameRu: 'Люкс-поезда', nameAz: 'Lüks qatarlar' },
      { id: 'campervan-trips', name: 'Campervan Trips', nameRu: 'Кемпер-путешествия', nameAz: 'Kamper səfərləri' },
      { id: 'motorcycle-tours-transport', name: 'Motorcycle Tours', nameRu: 'Мототуры', nameAz: 'Motosiklet turları' },
      { id: 'sailing-trips', name: 'Sailing Trips', nameRu: 'Парусные путешествия', nameAz: 'Yelkənli səfərlər' },
      { id: 'cruise-travel', name: 'Cruise Travel', nameRu: 'Круизы', nameAz: 'Kruiz səyahəti' },
    ],
  },
  ...
  // По бюджету
  {
    ...
    nameAz: 'Büdcəyə görə',
    services: [
      { id: 'under-500', name: 'Under $500', nameRu: 'До $500', nameAz: '500$-dan az' },
  ...
  // Дополнительные услуги
  {
    ...
    nameAz: 'Əlavə xidmətlər',
    services: [
      { id: 'flight-included', name: 'Flight Included', nameRu: 'Перелёт включён', nameAz: 'Uçuş daxildir' },
      { id: 'flight-not-included', name: 'Flight Not Included', nameRu: 'Перелёт не включён', nameAz: 'Uçuş daxil deyil' },
      { id: 'airport-transfer', name: 'Airport Transfer', nameRu: 'Трансфер из аэропорта', nameAz: 'Hava limanı transferi' },
      { id: 'hotel-included', name: 'Hotel Included', nameRu: 'Отель включён', nameAz: 'Otel daxildir' },
      { id: 'meals-included', name: 'Meals Included', nameRu: 'Питание включено', nameAz: 'Yemək daxildir' },
      { id: 'visa-support', name: 'Visa Support', nameRu: 'Помощь с визой', nameAz: 'Viza dəstəyi' },
      { id: 'travel-insurance', name: 'Travel Insurance', nameRu: 'Страховка', nameAz: 'Səyahət sığortası' },
      { id: 'esim-included', name: 'eSIM Included', nameRu: 'eSIM включён', nameAz: 'eSIM daxildir' },
      { id: 'local-guide-included', name: 'Local Guide Included', nameRu: 'Местный гид включён', nameAz: 'Yerli bələdçi daxildir' },
      { id: 'equipment-included', name: 'Equipment Included', nameRu: 'Снаряжение включено', nameAz: 'Avadanlıq daxildir' },
      { id: 'flexible-cancellation', name: 'Flexible Cancellation', nameRu: 'Гибкая отмена', nameAz: 'Esnek ləğvetmə' },
      { id: 'instant-booking', name: 'Instant Booking', nameRu: 'Мгновенное бронирование', nameAz: 'Ani bron' },
    ],
  },
];
