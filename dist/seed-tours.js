...
const tour_entity_1 = require("./modules/tours/entities/tour.entity");
const constants_1 = require("./common/constants");
const user_entity_1 = require("./modules/users/entities/user.entity");
const booking_entity_1 = require("./modules/bookings/entities/booking.entity");
const passenger_entity_1 = require("./modules/bookings/entities/passenger.entity");
...
const chat_room_entity_1 = require("./modules/chat/entities/chat-room.entity");
const chat_member_entity_1 = require("./modules/chat/entities/chat-member.entity");
const message_entity_1 = require("./modules/chat/entities/message.entity");
const itinerary_item_entity_1 = require("./modules/tours/entities/itinerary-item.entity");
const tour_media_entity_1 = require("./modules/tours/entities/tour-media.entity");
const payout_entity_1 = require("./modules/payments/entities/payout.entity");
const stripe_event_entity_1 = require("./modules/payments/entities/stripe-event.entity");
...
const AppDataSource = new typeorm_1.DataSource({
    ...
    synchronize: false,
    entities: [
        tour_entity_1.Tour, user_entity_1.User, booking_entity_1.Booking, passenger_entity_1.Passenger, review_entity_1.Review, payment_entity_1.Payment,
        chat_room_entity_1.ChatRoom, chat_member_entity_1.ChatMember, message_entity_1.Message, itinerary_item_entity_1.ItineraryItem, tour_media_entity_1.TourMedia,
        payout_entity_1.Payout, stripe_event_entity_1.StripeEvent,
    ],
});
const tours = [
...
async function seed() {
    try {
        ...
        const tourRepo = AppDataSource.getRepository(tour_entity_1.Tour);
        ...
        for (const t of tours) {
            try {
                ...
                const tour = tourRepo.create({
                    ...
                    status: constants_1.TourStatus.ACTIVE,
...
seed();
//# sourceMappingURL=seed-tours.js.map